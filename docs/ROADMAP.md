...
| FEATURE-033 — Lifecycle 01-PROJECT-BRIEF-TEMPLATE (diseño aprobado) | Alto | Bajo | Alta |
...
**Estado:** Diseño aprobado (GO) — pendiente de implementación por Development.
Ver `docs/features/FEATURE-033-Lifecycle-canónico-de-Project-Brief-basado-en-el-Runbook.md`.
